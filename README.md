...
- [mnemoverse/mcp-memory-server](https://github.com/mnemoverse/mcp-memory-server) <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" width="16" height="16"/> ☁️ - Hosted persistent memory for AI agents that re-ranks recall by whether a recalled memory helped or misled, with shared rooms for multi-agent work; remote endpoint with OAuth sign-in or a local npx server with a free API key
